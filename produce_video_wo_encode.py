...
def encode_and_send(frame_queue, server_ip, server_port, topic_name, cur_fps, threshold_time):
...
def produce_video_stream(server_ip, server_port, topic_name, threshold_time):
    ...
    with ThreadPoolExecutor(max_workers=2) as executor:
        ...
        executor.submit(encode_and_send, frame_queue, server_ip, server_port, topic_name, cur_fps, threshold_time)
